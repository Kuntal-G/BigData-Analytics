...
public class FriendSuggesterDriver  extends Configured implements Tool {
    ...
    private static Logger theLogger = Logger.getLogger(FriendSuggesterDriver.class);
    ...
    public int run(String[] args) throws Exception {
       ...
       job1.setJarByClass(FriendSuggesterDriver.class);
       ...
       job2.setJarByClass(FriendSuggesterDriver.class);
    ...
    public static int submitJob(String[] args) throws Exception {
       ...
       //     args[1] = input path
       //     args[2] = output path
       int returnStatus = ToolRunner.run(new FriendSuggesterDriver(), args);
       return returnStatus;
    }
}
